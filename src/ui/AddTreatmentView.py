...
class Ui_AddTreatment(object):
    def setupUi(self, AddTreatment):
        ...
        self.AddExerciseCombo.setGeometry(QtCore.QRect(400, 320, 391, 301))
        ...
        self.comboBox = QtWidgets.QComboBox(self.AddExerciseCombo)
        self.comboBox.setGeometry(QtCore.QRect(120, 30, 251, 41))
        self.comboBox.setObjectName("comboBox")
        self.spinBox = QtWidgets.QSpinBox(self.AddExerciseCombo)
        ...
        self.spinBox_2 = QtWidgets.QSpinBox(self.AddExerciseCombo)
        ...
        self.diagnose3 = QtWidgets.QLineEdit(self.AddExerciseCombo)
        ...
        self.PatientAge.setGeometry(QtCore.QRect(80, 50, 211, 21))
    ...
    def retranslateUi(self, AddTreatment):
        ...
        self.PatientAge.setText(_translate("AddTreatment", "18 age"))
