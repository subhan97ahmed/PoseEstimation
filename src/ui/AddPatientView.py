...
class Ui_AddPatient(object):
    ...
    def retranslateUi(self, AddPatient):
        ...
        self.commandLinkButton_4.setText(_translate("AddPatient", "Home"))
        self.commandLinkButton_5.setText(_translate("AddPatient", "Treatments"))
        self.commandLinkButton_6.setText(_translate("AddPatient", "Reports"))
        ...
        self.patient_name_3.setText(_translate("AddPatient", "Patient Name"))
        self.patient_age_6.setText(_translate("AddPatient", "18"))
        self.patient_age_7.setText(_translate("AddPatient", "email@gmail.com"))
        self.patient_age_8.setText(_translate("AddPatient", "03451234XXX"))
